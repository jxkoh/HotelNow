package hotelnow.hotelnow.ReviewActivity.util;
...
import hotelnow.hotelnow.ReviewActivity.SearchActivity;
import hotelnow.hotelnow.ReviewActivity.SearchFragment;
import hotelnow.hotelnow.ReviewActivity.WatchListFragment;
...
public class PostListAdapter extends RecyclerView.Adapter<PostListAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_view_post_reviews, parent, false);
